...
@section('container')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Create New Asupan Gizi</h1>
    </div>

    <div class="col-lg-8">
        <form method="post" action="/dashboard/asupans" class="mb-5" enctype="multipart/form-data">
            @csrf
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input id="deskripsi_gizi" type="hidden" name="deskripsi_gizi" value="{{ old('deskripsi_gizi') }}">
            ...
            <button type="submit" class="btn btn-primary">Create Asupan</button>
        </form>
    </div>
